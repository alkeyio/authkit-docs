...
- [Extension System](/vi/concepts/extensions) covers what you register onto a `Config` beyond managers.
- [Models](/vi/api/models) is the reference for what each `Set*Manager` call expects.
